    ...
    >
      ...
      <div className="container mx-auto container-padding pt-16 md:pt-20 z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <div 
            className="bg-sanika-blue/10 text-white text-xs md:text-sm px-4 py-1 rounded-full mb-4 md:mb-6 backdrop-blur-sm transition-all duration-700 transform translate-y-0 opacity-100"
            style={{ animationDelay: "200ms" }}
          >
            Established 2009 | Pune, India
          </div>
          <h1 
            className="text-3xl md:text-4xl lg:text-6xl font-bold text-white mb-4 md:mb-6 tracking-tight transition-all duration-700 transform translate-y-0 opacity-100"
          ...
          <p 
            className="text-white text-base md:text-xl max-w-2xl mb-6 md:mb-10 leading-relaxed transition-all duration-700 transform translate-y-0 opacity-100"
